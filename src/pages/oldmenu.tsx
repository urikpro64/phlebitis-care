      ...
      <div className="h-full flex flex-col justify-center items-center space-y-2">
        ...
        <div className="flex flex-row space-x-2">
          <div className="w-full">
            <Link href="/operation">
            <div className="flex flex-col h-full items-center justify-center bg-primary rounded-lg">
          ...
          <div className="w-full">
            ...
            <div className="flex flex-col h-full items-center justify-center p-4 bg-primary rounded-lg">
              <div className="w-32 h-32 mb-2 p-4 rounded-full bg-white shadow-lg">
